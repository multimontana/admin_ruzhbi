...
<!--        </div>-->
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-lg" name="title" v-model="item.title">
        </div>
        <div class="form-group">
            <label >Наценка категории *</label>
            <input type="text" class="form-control form-control-lg" name="markup" v-model="item.markup">
        </div>
        <div class="form-group">
